...
public class TvSeriesJson {
    ...
    public TvSeriesEntity getJPAEntity(){
        ...
        tvSeriesEntity.setOverview(this.overview);
        tvSeriesEntity.setPoster(this.poster);
        tvSeriesEntity.setUrl(this.url);
        tvSeriesEntity.setYear(this.year);
        ...
        for(ActorJson actor: this.people.getActors()){
            actorEntities.add(actor.getJPAEntity());
        }
        ...
        tvSeriesEntity.setImdb_id(this.imdb_id);
        tvSeriesEntity.setTvrage_id(this.tvrage_id);
