...
import serializablesupernonserializablesub.Person;
import serializablesupernonserializablesub.Student;

public class TestBothSerializable {

	public static void main(String[] args) throws IOException,
			ClassNotFoundException {

		SerializeDeserializeObject utilObject = new SerializeDeserializeObject(
				"student.txt");
