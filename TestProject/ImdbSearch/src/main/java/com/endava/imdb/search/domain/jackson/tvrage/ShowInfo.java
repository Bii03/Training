 ...
 *
 *  This class is used in order to map the callback server detailed response to an object.
 *  Since the server gives a complex response, the ShowInfo object makes use of other objects in order to
